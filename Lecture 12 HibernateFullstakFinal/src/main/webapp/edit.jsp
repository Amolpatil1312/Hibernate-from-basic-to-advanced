...
<table>
	...
	<tr>
		...
		<td><input type="text" name="custdepartment" value="<%=customer.getCustDepartment()%>"/></td>
	</tr>
	...
	<tr>
		...
		<td><input type="password" name="custpassword" value="<%=customer.getCustPassword()%>"/></td>
	</tr>
	<tr>
		<td></td>
